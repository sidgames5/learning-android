...
class MemoryBoardAdapter(private val context: Context, private val pieces: Int) : RecyclerView.Adapter<MemoryBoardAdapter.ViewHolder>() {
    ...
    override fun getItemCount() = pieces
